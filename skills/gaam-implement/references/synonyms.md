...
- **Functional signature:** typed baseline work-item failure catalogue with manual cost/risk/adversarial tags - produces comparable L0 evidence - prevents unfalsifiable improvement claims.
...
- **Detection signals:**
  - Files/dirs: `baseline_cases/`, `level_00/`, `prompts/`, `baseline-report`
...
- **Functional signature:** explicit workflow, owners, policies, templates, validation, L0 failure mappings, and human-reviewed AI process suggestions - produces process substrate - prevents automating undocumented habits or treating process-review output as production judgment.
...
- **Detection signals:**
  - Files/dirs: `human_process/`, `workflow.yaml`, `policies.yaml`, `templates/`, `level-00-baseline-to-process`
...
- **Detection signals:**
  - Files/dirs: `threat-model.yaml`, `threat_model`, `security/`, `level_00/`
...
- **Detection signals:**
  - Files/dirs: `knowledge-coverage`, `knowledge_base/`, `knowledge-index`, `level_00/evals`
...
- **Detection signals:**
  - Files/dirs: `retrieval-evals`, `retrieval-signals`, `evals/`, `level_00/`
...
- **Detection signals:**
  - Files/dirs: `review/`, `human_review`, `level_01`, `assistant_output`
...
- **Detection signals:**
  - Files/dirs: `framing`, `prompt_assembly`, `adversarial`, `level_01`
...
- **Detection signals:**
  - Files/dirs: `adversarial/detection`, `patterns/v1`, `injection`, `level_01`
...
- **Functional signature:** tools declare schemas, scope, and read-only side-effect class - produces manifests - prevents untyped or write-capable L2 tools.
- **Alternative names:** tool manifest, scoped tools, typed tools, read-tool manifest, tool schema registry
- **Detection signals:**
  - Files/dirs: `tools/read-tools`, `tool_registry`, `manifests`, `level_02/tools`
...
- **Detection signals:**
  - Files/dirs: `access/`, `grants`, `tool_registry`, `level_02`
...
- **Detection signals:**
  - Files/dirs: `tool_registry`, `audit`, `redaction`, `level_02`
...
- **Detection signals:**
  - Files/dirs: `mcp_adapter`, `protocol_conformance`, `level_02_server`, `mcp/`
...
- **Detection signals:**
  - Files/dirs: `sanitization`, `tool-output`, `adversarial`, `level_02/examples`
...
- **Detection signals:**
  - Files/dirs: `implementations/*/level_02`, `framework_tracks`, `tool_registry`
...
- **Detection signals:**
  - Files/dirs: `level_03`, `native_runtime`, `action_tools`, `action_templates`
...
- **Detection signals:**
  - Files/dirs: `approvals`, `level_03/inputs`, `approval-binding`, `native_runtime`
...
- **Detection signals:**
  - Files/dirs: `access/authority`, `action_grants`, `actions`, `level_03`
...
- **Detection signals:**
  - Files/dirs: `idempotency`, `actions`, `incident`, `level_03/examples`
...
- **Detection signals:**
  - Files/dirs: `rollback`, `incident`, `actions`, `level_03`
...
- **Detection signals:**
  - Files/dirs: `signing`, `adversarial_keys`, `approvals`, `level_03`
...
- **Detection signals:**
  - Files/dirs: `external_output_safety`, `customer_safety`, `data`, `level_03`, `approval_gate`
...
- **Detection signals:**
  - Files/dirs: `goals`, `level_04/inputs`, `goal-record`, `signed_goals`
...
- **Detection signals:**
  - Files/dirs: `predicates`, `goals/predicates`, `success_criteria`, `level_04`
...
- **Detection signals:**
  - Files/dirs: `stop_reasons`, `budget`, `progress`, `escalation`, `level_04`
...
- **Detection signals:**
  - Files/dirs: `memory`, `validators`, `memory-record`, `level_04/examples`
...
- **Detection signals:**
  - Files/dirs: `agent_cards`, `agents`, `level_05/inputs`, `a2a`
...
- **Detection signals:**
  - Files/dirs: `validator`, `handoff`, `validation-decision`, `level_05`
...
- **Detection signals:**
  - Files/dirs: `checkpoint`, `orchestrator`, `sqlite_checkpoint`, `level_05/examples`
...
- **Detection signals:**
  - Files/dirs: `policy`, `eligibility`, `level_06/inputs`, `worker`
...
- **Detection signals:**
  - Files/dirs: `global_pause`, `dead_letter`, `policy/queue`, `level_06/examples`
...
- **Detection signals:**
  - Files/dirs: `adversarial_corpus`, `red_team`, `level_06/examples`, `policy`
...
- **Detection signals:**
  - Files/dirs: `proposals`, `level_07/inputs`, `improvement-proposal`, `change_control`
...
- **Detection signals:**
  - Files/dirs: `release_gate`, `adversarial_evals`, `candidate-release`, `level_07/examples`
