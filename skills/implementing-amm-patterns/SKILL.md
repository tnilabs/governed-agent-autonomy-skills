...
`references/patterns.md`, `references/controls.md`, `references/rosetta.md`. Cite their `canon_version` in the implementation plan.
...
## Existing capability survey (rosetta-driven)
